...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			?>
				<a style="float:right;" href="cart.php" class="btn btn-warning">Procced&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
			<?php
			exit();
		}
	}
					...
					echo '
						<div class="row" style="margin-top: 30px;">
        					<div class="col-md-12 text-center">
								<a href="cod.php" class="btn btn-warning" style="width:30%;">
										CASH ON DELIVERY </br></a>
